function distance = calc_distance_based_on_rssi(ap, varargin)
    ...
    ope_9 = struct('Name', 'ope_9', 'A', -19.91 + env_factor, ...
        'n', 3.363);
	Beacon1 = struct('Name', 'Beacon1', 'A', -19.91 + env_factor, ...
        'n', 3.363);
    Beacon2 = struct('Name', 'Beacon2', 'A', -19.91 + env_factor, ...
        'n', 3.363);
    Beacon3 = struct('Name', 'Beacon3', 'A', -19.91 + env_factor, ...
        'n', 3.363);
    Beacon4 = struct('Name', 'Beacon4', 'A', -19.91 + env_factor, ...
        'n', 3.363);
    Beacon5 = struct('Name', 'Beacon5', 'A', -19.91 + env_factor, ...
        'n', 3.363);
