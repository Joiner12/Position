function distance = calc_distance_based_on_rssi(ap, varargin)
    ...
    %% 偏置拟合结果
    ope_1 = struct('Name', 'ope_1', 'A', -19.91, ...
        'n', 3.363);
    ope_2 = struct('Name', 'ope_2', 'A', -19.91 - 2, ...
        'n', 3.363);
    ope_3 = struct('Name', 'ope_3', 'A', -19.91, ...
        'n', 3.363);
    ope_4 = struct('Name', 'ope_4', 'A', -19.91, ...
        'n', 3.363);
    ope_5 = struct('Name', 'ope_5', 'A', -19.91, ...
        'n', 3.363);
    ope_6 = struct('Name', 'ope_6', 'A', -19.91, ...
        'n', 3.363);
    ope_7 = struct('Name', 'ope_7', 'A', -19.91, ...
        'n', 3.363);
    ope_8 = struct('Name', 'ope_8', 'A', -19.91, ...
        'n', 3.363);
