...
| 数据源                                          | 拟合模型(Coefficients (with 95% confidence bounds))          | SSE                                                          | RSQUARE | ADJRSQUARE | RMSE |
| ----------------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------- | ---------- | ---- |
| 所有蓝牙设备相同距离RSSI观测值均值（mean-mean） | f(x) = p1*x^2 + p2*x + p3<br>p1 =     0.02856  (-0.01443, 0.07155)<br>p2 =       2.224  (-2.417, 6.866)<br>p3 =       43.38  (-81.11, 167.9) | sse: 1.277106792362791e+02<br/>       rsquare: 0.736407266798186<br/>           dfe: 15<br/>    adjrsquare: 0.701261569037944<br/>          rmse: 2.917883699261951 |         |            |      |
| 所有蓝牙设备相同距离RSSI观测值均值              | f(x) = power(10,(a-x)/10/b) <br>  a =      -36.46  (-46.34, -26.57)<br>  b =       2.149  (1.247, 3.05) |                                                              |         |            |      |
|                                                 |                                                              |                                                              |         |            |      |
|                                                 |                                                              |                                                              |         |            |      |
|                                                 |                                                              |                                                              |         |            |      |
|                                                 |                                                              |                                                              |         |            |      |
